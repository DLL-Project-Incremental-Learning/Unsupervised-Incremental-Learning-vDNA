...
def get_argparser():
    ...
    parser.add_argument("--json_file1", type=str, required=True, help='path to the first JSON file containing image and label paths')
    parser.add_argument("--json_file2", type=str, required=True, help='path to the second JSON file containing image and label paths')
    return parser
