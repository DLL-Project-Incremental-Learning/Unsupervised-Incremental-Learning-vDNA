...
python main2.py --data_root datasets/data/cityscapes --ckpt checkpoints/best_bucket_5_asc_deeplabv3plus_resnet101_kitti_os16.pth --model deeplabv3plus_resnet101 --test_only --crop_val --val_batch_size 2
...
python -m test_v1  --checkpoint checkpoints/best_bucket_5_asc_deeplabv3plus_resnet101_kitti_os16.pth --json_file kitti-360_val_set_v1.json --dataset kitti_360

2. Test only setup for Cityscapes

python -m test_v1  --checkpoint checkpoints/best_bucket_5_asc_deeplabv3plus_resnet101_kitti_os16.pth --json_file cityscapes_val_set.json --dataset cityscapes
